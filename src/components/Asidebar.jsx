...
const Asidebar = () => {
    ...
    const asideItems =[
            ...
            },
            {
                ...
                navTitle : 'Driver Bin',
                roles: ['outlet'],
                icon : "M28 13h1c0.6 0 1-0.4 1-1s-0.4-1-1-1h-2.8L25 8c-0.8-1.8-2.6-3-4.6-3h-8.7C9.6 5 7.8 6.2 7 8l-1.3 3H3c-0.6 0-1 0.4-1 1s0.4 1 1 1h1c-1.2 0.9-2 2.4-2 4v4c0 0.9 0.4 1.7 1 2.2V25c0 1.7 1.3 3 3 3h2c1.7 0 3-1.3 3-3v-1h10v1c0 1.7 1.3 3 3 3h2c1.7 0 3-1.3 3-3v-1.8c0.6-0.5 1-1.3 1-2.2v-4C30 15.4 29.2 13.9 28 13z",
                viewBox: "0 0 30 30",
                path : '/outlet/drivers'
            },
            {
                name : 'Outlet Assignments',
                navTitle : 'Outlet Assignments',
                roles: ['outlet'],
            ...
            {
                name : 'Business Types',
                navTitle : 'Business Type Management',
            ...
            {
                name : 'Transports',
                navTitle : 'Transport Management',
                icon : "M192,7.10542736e-15 L384,110.851252 L384,332.553755 L192,443.405007 L1.42108547e-14,332.553755 L1.42108547e-14,110.851252 L192,7.10542736e-15 Z M127.999,206.918 L128,357.189 L170.666667,381.824 L170.666667,231.552 L127.999,206.918 Z M42.6666667,157.653333 L42.6666667,307.920144 L85.333,332.555 L85.333,182.286 L42.6666667,157.653333 Z M275.991,97.759 L150.413,170.595 L192,194.605531 L317.866667,121.936377 L275.991,97.759 Z M192,49.267223 L66.1333333,121.936377 L107.795,145.989 L233.374,73.154 L192,49.267223 Z",
                viewBox: "0 0 420 420",
                path : '/transport-management'
            },
            {
                name : 'Transport Shipments',
                navTitle : 'Shipment Management',
                icon : "M192,7.10542736e-15 L384,110.851252 L384,332.553755 L192,443.405007 L1.42108547e-14,332.553755 L1.42108547e-14,110.851252 L192,7.10542736e-15 Z M127.999,206.918 L128,357.189 L170.666667,381.824 L170.666667,231.552 L127.999,206.918 Z M42.6666667,157.653333 L42.6666667,307.920144 L85.333,332.555 L85.333,182.286 L42.6666667,157.653333 Z M275.991,97.759 L150.413,170.595 L192,194.605531 L317.866667,121.936377 L275.991,97.759 Z M192,49.267223 L66.1333333,121.936377 L107.795,145.989 L233.374,73.154 L192,49.267223 Z",
                viewBox: "0 0 420 420",
            ...
            {
                name : 'Visibility',
                navTitle : 'Visibility by Admin Panel',
  ...
  return (
    ...
    w-[20%] bg-white pt-3 flex flex-col min-h-0">
       ...
       {asideItems
        .filter((item) => (item.roles || ['admin']).includes(userType))
        .map((item,index)=>(
        <NavLink
        key={index}
  to={item.path}
